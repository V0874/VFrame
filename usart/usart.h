...
usart_mode_t USART0_MODE;                                       // USART mode that corresponds to each peripheral
usart_mode_t USART1_MODE;
usart_mode_t USART2_MODE;
usart_mode_t USART3_MODE;
...
void usart_send(usart_t* usart, unsigned char data);           // test function to test communication
